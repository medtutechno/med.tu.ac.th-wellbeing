...
<!-- Date & Time Section -->
    ...
    <div class="mt-4 details">
      <h5>รายละเอียดเพื่อทำนัดนักจิตวิทยา</h5>
      
      <p class="mb-3">{{ selectedFullDate }} {{ selectedDate == null ?    '' :  'เวลา' }} {{ selectedTime }}</p>
    
      <!-- Student Information Form -->
      <div class="booking-form p-3 mb-3">
        <h6 class="mb-3">ข้อมูลสำหรับติดต่อนัดหมาย(โปรดกรอกข้อมูลในการทำนัดให้ถูกต้อง ครบถ้วน)</h6>
      ...
      <!-- Temporarily hidden HCaptcha -->
      <!-- <div class="hcaptcha-container mt-3 mb-3">
        <HCaptcha
...
export default {
  ...
  methods: {
    ...
    initializeForm() {
      // ถ้ามีข้อมูลจาก query parameters ให้ตรวจสอบความถูกต้องของข้อมูลทันที
      if (this.$route.query.name) {
        Object.keys(this.studentInfo).forEach(field => {
    ...
    async submitBooking() {
      ...
      //     text: 'โปรดทำการยืนยันตัวตนก่อนทำการจอง',
